...
const recoverPass = (token) => {
  ...
  <h2>Hello there,</h2>
  <p>
    Forgot your password? Click the button and recover your
    password.
  </p>
  <button style="background-color: green; padding:10px; border:none; margin-top:10px;">
      <a style="color: white; text-decoration: none" href=${FRONTEND_URL}/recover_password?token=${token} >Recover password</a>
  </button>
</div>`;
};
